public class VCVSE extends VolSource {
    double gain;
    Node startNodeD;
    Node endNodeD;
    int startD;
    ...
    public VCVSE(String name, String startNode, String endNode,
    ...
    public static double maxwellType2(VCVSE vcvse) {
        vcvse.voltage = vcvse.gain * (Circuit.noNodeHM.get(vcvse.startD).voltagePresent
                -Circuit.noNodeHM.get(vcvse.endD).voltagePresent);
        return vcvse.voltage;
    }
